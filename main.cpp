...
void initMain(void){
  ...
  * -C++ with STL shall increase the size of your application (bin file) by at least 300k
  ...
  *  therefore if you need more RAM3, you can place mp3 DMA buffers in ram0, see note associate with wave_buf array in mad.c for details
